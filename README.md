...
| 2025-12-29 | 📊 주간 트렌드 분석: 전기차(EV) 판매 동향        | [Electric Vehicle Population Data - Kaggle](https://www.kaggle.com/datasets/mrtim2/2023-global-ev-sales) | 회귀 분석 결과, 충전소 밀도 1단위 증가는 연간 판매량 119대의 증가($R^2=0.84$)로 직결되며, 이는 보조금 정책보다 인프라 확장이 3.5배 더 높은 판매 견인력을 가짐을 시사합니다. | [👉 읽기](projects/20251229_EV_Sales_Trends/reports/insight_report.md)           |
